class VapoursynthPlugins < Formula
  ...
  homepage "https://github.com/inflation/vs_plugins"
  license "LGPL-2.1-or-later"
  head "https://github.com/inflation/vs_plugins.git"
  ...
  def install
    ...
    Dir.chdir("descale") do
      system "meson", "build"
      system "ninja", "-C", "build"
      vslib.install "build/libdescale.dylib"
    end
    ...
    # end
    Dir.chdir("VapourSynth-NNEDI3CL") do
      system "meson", "build"
      system "ninja", "-C", "build"
      vslib.install "build/libnnedi3cl.dylib"
      vslib.install "NNEDI3CL/nnedi3_weights.bin"
    end
